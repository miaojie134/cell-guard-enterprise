...
const PHONE_STATUS_MAP: Record<BackendPhoneStatus, FrontendPhoneStatus> = {
  ...
  [BACKEND_PHONE_STATUS.SUSPENDED]: FRONTEND_PHONE_STATUS.SUSPENDED,
  [BACKEND_PHONE_STATUS.CARD_REPLACING]: FRONTEND_PHONE_STATUS.CARD_REPLACING,
};
